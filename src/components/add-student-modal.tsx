                ...
                >
                  ...
                  {uploadedFile ? (
                    <div className="text-center">
                      <svg className="w-8 h-8 mx-auto mb-2 text-[#059669]" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                      ...
                      <button
                        type="button"
                        className="text-[10px] mt-2 text-red-500 hover:underline cursor-pointer"
                        onClick={(e) => {
                          e.stopPropagation();
                          setUploadedFile(null);
                        }}
